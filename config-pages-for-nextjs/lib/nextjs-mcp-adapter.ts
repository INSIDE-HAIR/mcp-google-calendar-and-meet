// Next.ts 15 MCP Adapter - Integrates Google Meet MCP Server with Next.ts
import { GoogleMeetAPI } from "./google-meet-mcp/GoogleMeetAPI";
import type { GoogleTokens, MCPRequest, MCPResponse, MCPTool } from "@/types/mcp";

export class NextJSMCPAdapter {
  private userCredentials: GoogleTokens;
  private googleMeetAPI: GoogleMeetAPI | null = null;

  constructor(userCredentials: GoogleTokens) {
  ...
  async handleMCPRequest(mcpRequest: MCPRequest): Promise<MCPResponse> {
    try {
    ...
    return {
      tools: [
        // Calendar API v3 tools
        {
          ...
          description:
            "List calendar events with optional Meet links filtering",
          inputSchema: {
            type: "object",
            properties: {
        ...
        },
        {
          ...
          description:
            "Get specific calendar event details including guest permissions",
          inputSchema: {
            type: "object",
            properties: {
              calendar_id: { type: "string", default: "primary" },
        ...
        },
        {
          ...
          description:
            "Create calendar event with optional Google Meet conference and guest permissions",
          inputSchema: {
            type: "object",
            properties: {
              calendar_id: { type: "string", default: "primary" },
        ...
        },
        {
          ...
          description:
            "Update existing calendar event including all guest permissions",
          inputSchema: {
            type: "object",
            properties: {
              calendar_id: { type: "string", default: "primary" },
        ...
        // Meet API v2 tools
        {
          ...
          description:
            "Create Google Meet space with advanced enterprise configuration",
          inputSchema: {
            type: "object",
            properties: {
              access_type: {
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              recording_name: {
                type: "string",
                description: "Recording resource name",
              },
            },
  ...
  async callTool(toolName: string, args: Record<string, any>): Promise<MCPResponse> {
    try {
      ...
      if (!this.googleMeetAPI) {
        throw new Error("Google Meet API not initialized");
      }
