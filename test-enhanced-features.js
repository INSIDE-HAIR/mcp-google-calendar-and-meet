...
class EnhancedFeaturesTester {
  constructor() {
    ...
    if (!credentialsPath || !tokenPath) {
      throw new Error(
        "Missing credentials configuration. Set G_OAUTH_CREDENTIALS or GOOGLE_MEET_CREDENTIALS_PATH/GOOGLE_MEET_TOKEN_PATH"
      );
    }
  ...
  async testBasicMeetingCreation() {
    ...
    try {
      ...
      this.logResult(
        ...
        true,
        `Created meeting: ${meeting.meet_link}`
      );
  ...
  async testMeetingWithCoHosts() {
    ...
    try {
      ...
      this.logResult(
        "Co-hosts Meeting",
        true,
        `Created meeting with co-hosts: ${meeting.meet_link}`
      );
  ...
  async testMeetingWithTranscription() {
    ...
    try {
      ...
      this.logResult(
        ...
        true,
        `Created meeting with transcription: ${meeting.meet_link}`
      );
  ...
  async testMeetingWithAllFeatures() {
    ...
    try {
      ...
      this.logResult(
        "All Features Meeting",
        true,
        `Created comprehensive meeting: ${meeting.meet_link}`
      );
  ...
  async testMeetingWithModeration() {
    ...
    try {
      ...
      this.logResult(
        "Moderation Meeting",
        true,
        `Created moderated meeting: ${meeting.meet_link}`
      );
  ...
  printSummary() {
    ...
    if (passed === total) {
      ...
      console.log(
        "   Note: Some failures may be expected if you don't have Google Workspace Business+"
      );
    }
  }
}
